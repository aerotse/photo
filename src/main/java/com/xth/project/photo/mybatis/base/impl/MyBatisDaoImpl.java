package com.xth.project.photo.mybatis.base.impl;
        ...
        return (Integer) execute(new SqlSessionCallback() {
            ...
            public Object doInSession(SqlSession session) {
                try {
                    ...
                    logger.error("SQL执行出错: " + sqlMapId + " : "+ e.getMessage() , e);
                    throw e;
//                    throw new DatabaseException("SQL执行出错: " + sqlMapId + " : "+ e.getMessage() , e);
                }
            }
        });
    }
